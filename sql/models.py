...
class workflow(models.Model):
    ...
    status = models.CharField(max_length=50, choices=tuple([(v,v) for k,v in Const.workflowStatus.items()]))
    ...
    affirm_time = models.DateTimeField('结束时间', null=True, blank=True)
